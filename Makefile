...
PRJSRC=src/main.c src/ledusb.c src/mixer.c usbdrv/usbdrv.c usbdrv/usbdrvasm.S

# additional includes (e.g. -I/path/to/mydir)
INC=-Iinclude -Iusbdrv
...
# compiler
CFLAGS=-I. $(INC) -DF_CPU=$(F_CPU) -g -mmcu=$(MCU) -O$(OPTLEVEL) \
...
# assembler
ASMFLAGS =-I. $(INC) -DF_CPU=$(F_CPU) -mmcu=$(MCU)        \
